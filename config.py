...
USE_PIPER_TTS = os.getenv("USE_PIPER_TTS", "false").lower() in ("true", "1", "yes")
PIPER_MODEL_PATH = os.getenv("PIPER_MODEL_PATH", "")
PIPER_MODEL = os.getenv("PIPER_MODEL", "tr_TR-dfki-medium")
ELEVENLABS_API_KEY = os.getenv("ELEVENLABS_API_KEY", "")
ELEVENLABS_MODEL_ID = os.getenv("ELEVENLABS_MODEL_ID", "eleven_multilingual_v2")
# Azure AI Speech — when both set, preferred over Edge (ElevenLabs voice still wins)
AZURE_SPEECH_KEY = os.getenv("AZURE_SPEECH_KEY", "") or os.getenv("AZURE_TTS_KEY", "")
AZURE_SPEECH_REGION = os.getenv("AZURE_SPEECH_REGION", "") or os.getenv("AZURE_TTS_REGION", "")
PREFER_AZURE_TTS = os.getenv("PREFER_AZURE_TTS", "true").lower() in ("true", "1", "yes")
