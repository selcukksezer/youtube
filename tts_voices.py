...
def _native_voice_prefix(lang: str) -> str:
    return {"tr": "tr-TR-", "en": "en-"}.get((lang or "tr").lower(), "tr-TR-")


def _is_native_voice(voice_id: str, lang: str) -> bool:
    if not voice_id or is_elevenlabs_voice(voice_id):
        return True
    return voice_id.startswith(_native_voice_prefix(lang))
